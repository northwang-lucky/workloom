 ...
 * （自有 alignment/update-spec/packages-scan + 三个 vendored mattpocock
 * skills），连同目录内所有文件（SKILL.md / references / agents / 子文档 /
 * scripts 脚本资产）与 mattpocock 的 LICENSE。
 *
...
/** 相对本包根的资源源目录（整目录递归拷贝）。
 * 自有 workloom 侧注册 alignment（统一 Phase 1.1）、update-spec 与 packages-scan；
