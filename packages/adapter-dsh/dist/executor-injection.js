 ...
 */
export function buildFullInjection(root, taskRelPath, kind, userPrompt, localDirectives, hasLsp) {
 ...
 */
export function injectionStats(built, toolsAllowed) {
    return {
 ...
 * @returns 子会话标题
 */
export function buildChildLabel(root, taskRelPath, kind, title) {
...
//# sourceMappingURL=executor-injection.js.map