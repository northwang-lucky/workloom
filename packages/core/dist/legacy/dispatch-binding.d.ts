 ...
 */
export function resolveDispatchModelSource(params: {
    model?: string;
}, effective: import("./config.d.ts").ResolveSubagentDefaultsResult): "param" | "whenMain" | "fallback" | "legacy" | "inherit";
/**
 ...
 */
export function buildNewDispatchBinding(params: {
    model?: string;
}, effective: import("./config.d.ts").ResolveSubagentDefaultsResult, mainModel?: string): {
    model?: string;
    effort?: string;
    modelSource: "param" | "whenMain" | "fallback" | "legacy" | "inherit";
};
