...
function pointerPath(root, contextKey) {
    if (!CONTEXT_KEY_PATTERN.test(contextKey)) {
        throw new Error(`${ERR_PREFIX}: invalid contextKey (alphanumerics, underscore, and hyphen only): ${contextKey}`);
    }
...
//# sourceMappingURL=active-task.js.map