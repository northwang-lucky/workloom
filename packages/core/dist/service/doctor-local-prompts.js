 ...
 * @returns issues + info
 */
export function checkLocalPrompts(root, homeDir) {
 ...
 * @param info 正向状态行收集
 */
function scanPromptDir(spec, issues, info) {
    let entries;
    try {
...
//# sourceMappingURL=doctor-local-prompts.js.map